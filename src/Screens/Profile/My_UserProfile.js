...
const My_UserProfile = ({navigation}) => {
    const data= {
        username: 'JohnnyLuengo',
        followers: 1100,
        following: 1500,
        description: "Espero salir bien en este proyecto T-T",
        ...
        posts : [
            ...
            {
                id: 4,
                post_image: 'https://picsum.photos/100/150',
            },
            {
                id: 5,
            ...
            <ScrollView>
                <View style={styles.c1}>
                    ...
                    <View style={styles.c11}>
                        ...
                        <View style={styles.c111}>
                            <Text style={styles.txt1}>Siguiendo</Text>
                ...
                <View style={styles.c1}>
                    <Text style={styles.txt}>Tus Posts</Text>
